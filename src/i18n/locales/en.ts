...
export const en: TranslationDict = {
  ...
  game: {
    ...
    bios: {
      ...
      softResetConfirm:
        "Are you sure you want to reload the page? Unsaved changes will be lost.",
      factoryReset: "Factory Reset",
      factoryResetHint: "Wipes all data & saves",
      factoryResetConfirm:
        "WARNING: This will wipe all save data and reset the game to factory state. This action cannot be undone. Are you sure?",
    },
    footer: {
  ...
  login: {
    ...
    logOut: "Log Out",
    logOutConfirm:
      "Log out {{username}}? This will close all open windows and discard unsaved changes.",
  ...
  browser: {
    ...
    error: {
      ...
      offlineDesc:
        "You are not connected to the internet. Please connect to a network to browse the web.",
    },
  },
  music: {
    sidebar: {
  ...
  os: {
    toasts: {
      musicNotInstalled:
        "Music app is not installed. Install it from the App Store.",
      notepadNotInstalled:
        "Notepad is not installed. Install it from the App Store.",
      photosNotInstalled:
        "Photos app is not installed. Install it from the App Store.",
    },
  },
  fileManager: {
    details: {
  ...
  settings: {
    ...
    placeholders: {
      ...
      securityDescription:
        "Firewall, permissions, and privacy settings coming soon.",
  ...
  onboarding: {
    ...
    validation: {
      ...
      fullNameFormat:
        "Full Name should only contain letters, spaces, and hyphens",
      usernameFormat:
  ...
  battery: {
    ...
    disclaimer:
      "Battery health and condition metrics are estimates based on available system sensors. Actual values may vary.",

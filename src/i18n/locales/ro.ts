...
export const ro: TranslationDict = {
    ...
    browser: {
        ...
        welcome: {
            title: 'Bun venit',
            subtitle: 'Site-urile tale favorite',
        },
    ...
    messages: {
        ...
        mock: {
            lastMessage: {
                seeYouTomorrow: 'Ne vedem mâine!',
                newMockupsReady: 'Noile modele sunt gata',
                thanksForTheHelp: 'Mulțumesc pentru ajutor!',
                meetingAt2pm: 'Ședință la ora 14',
                gotItThanks: 'Am înțeles, mersi!',
            },
            message: {
                heyHowAreYouDoing: 'Hei! Ce mai faci?',
                imGoodWorkingOnNewProject: 'Sunt bine, mersi! Lucrez la noul proiect.',
                thatSoundsExcitingCoffeeLater: 'Sună interesant! Vrei o cafea mai târziu?',
                sureHowAbout3pm: 'Sigur! Ce zici de ora 15?',
                seeYouTomorrow: 'Ne vedem mâine!',
                okFixResponsiveLayout: 'Ok—hai să reparăm layout-ul responsiv.',
            },
        },
        menu: {
